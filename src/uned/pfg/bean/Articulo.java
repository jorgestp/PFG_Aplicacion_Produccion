...
/**
 * Clase que representa a un bean de Articulo, que dispone de los siguientes
 * campos de clase; identificador de articulo, nombre del articulo, fecha de
 * entrada en el sistema y precio
 * 
...
public class Articulo {
	...
	/**
	 * Contructor que inicializa el id del articulo mediante el parametro del
	 * contructor.
	 * 
	 * @param id_articulo Valor numerico representativo a un identificador de
	 *                    articulo
	 */
	...
	/**
	 * Contructor que inicializa todos los campos de clase con los parametros que se
	 * le pasa a este constructor
	 * 
	 * @param id_articulo   Valor numerico representativo del identificador del
	 *                      articulo.
	 ...
	 * @param precio        Valor de tipo double que representa el precio que tiene
	 *                      el articulo
	 */
	...
	/**
	 * Constructor que inicializa los campos de clase nombre, fecha de entrada y
	 * precio.
	 * 
	 * @param nombre        String que representa al nombre que se le da al articulo
	 * @param fecha_entrada valor de tipo Date que representa la fecha
	 ...
	 * 
	 * @param fecha_entrada Valor de tipo Date que representa la fecha que se le da
	...
	/**
	 * Establece el valor del precio del articulo al valor que se le pasa por
	 * parametro
	 * 
	 * @param precio valor de tipo double que representra el precio que tiene el
	 *               articulo.
	 */
