...
/**
 * Clase que representa el bean de Pedido, que dispone de los siguientes campos
 * de clase;
 * 
 * Identificador de pedido, identificador del distribuidor, fecha de entrada y
 * de envio, estado del pedido y lista con los articulos que dispone el pedido.
 * 
 * 
...
public class Pedido {
	...
	/**
	 * Constructor que inicializa todas las variables de la clase con valores de los
	 * parametros.
	 * 
	 * @param id_pedido       Entero que representa el identificador de un pedidos
	 * @param id_distribuidor Entero que representa el identificador de un
	 *                        distribuidor.
	 * @param fecha_entrada   Representa la fecha de entrada del pedido en el
	 *                        sistema.
	 * @param fecha_envio     Representa la fecha de envio del pedido hacia el
	 *                        distribuidor.
	...
	/**
	 * Constructor que inicializa los 4 campos de clase con los valores de los
	 * parametros
	 * 
	 * @param id_distribuidor Entero que representa el identificador de un
	 *                        distribuidor.
	 ...
	 * 
	 * @param fecha_envio Valor de tipo Date que representa la fecha de envio del
	 *                    pedido
	 */
