...
/**
 * Clase que representa a un bean de cada articulo que tenga un pedido en
 * concreto, y cuyos campos de clase son los siguiente; Articulo cuyo tipo de
 * dato es el bean Articulo, cantidad de ese articulo, pedido al que representa
 * ese articulo, realizado que representa un boolean para conocer si esta
 * fabricado ese articulo o no, y embalado, que tambien representa un boolean
 * para conocer si el articulo ha sido embalado o no.
 * 
...
public class ArticuloPedido {
	...
	/**
	 * Constructor que inicializa todos los campos de clase con los parametros que
	 * tiene esta funcion.
	 * 
	 * @param articulo  Objeto de tipo Articulo en representacion al articulo que
	 *                  tiene el pedido
	 * @param cant      Valor numerico que representa la cantidad del articulo que
	 *                  se pide
	 * @param pedido    Objeto de tipo Pedido que representa al pedido en sí
	 * @param realizado Valor boolean que representa el estado realizado o no del
	 *                  articulo en el pedido
	 * @param embalado  Valor boolean que representa el estado embalado o no del
	 *                  articulo en el pedido.
	 */
	 ...
	 * 
	 * @param articulo Objeto de tipo articulo que representa un articulo que hay en
	 *                 el sistema
	 * @param cant     Valor numerico que representa la cantidad de ese articulo que
	 *                 se desea incluir en el pedido
	 */
	 ...
	 * 
	 * @return True, si el articulo ya esta realizado, o false, si aun no esta
	 *         realizado
	 */
	...
	/**
	 * Devuelve el valor del estado de embalado de un articulo en concreto dentro
	 * del pedido
	 * 
	 * @return True si el articulo del pedido esta embalado, false, si aun no esta
	 *         embalado
	 */
	...
	/**
	 * Establece el estado de embalado mediante el parametro que se le pasa a la
	 * funcion
	 * 
	...
	/**
	 * Devuelve un objeto de tipo Articulo que representa al articulo que hay en el
	 * pedido
	 * 
