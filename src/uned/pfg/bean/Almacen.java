 ...
 * los siguientes; id del articulo, cantidad almacenada en el almacen, y
 * cantidad que hay libre en el almacen.
 * 
 * 
...
public class Almacen {
	...
	/**
	 * Metodo para incializar los campos de la clase con los atributos pasados por
	 * parametro.
	 * 
	 * @param id_articulo.         Identificador del articulo que hay en el sistema.
	 * @param cantidad_almacenada. Cantidad numerica que hay almacenada de ese
	 *                             articulo en el almacen.
	 * @param cantidad_libre.      Cantidad numerica que hay libre de ese articulo
	 *                             en el almacen.
	 */
	 ...
	 * 
	 * @return Valor numerico representativo a la cantidad almacenada que hay de un
	 *         articulo
	 */
	 ...
	 * 
	 * @param cantidad_almacenada. Valor numerico representativo a la cantidad
	 *                             almacenada.
	 */
	 ...
	 * 
	 * @return Valor numerico representativo a la cantidad libre que hay en el
	 *         almacen.
	 */
	 ...
	 * 
	 * @param cantidad_libre. Valor numerico que representa a la cantidad libre de
	 *                        un articulo que hay en el almacen
	 */
