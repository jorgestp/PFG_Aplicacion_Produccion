...
/**
 * Clase que representa el bean de Distribuidor, que dispone de los siguientes
 * campos de clase;
 * 
 * identificador de distribuidor, telefono, codigo postal, nombre, domicilio,
 * email, pais, usuario, contraseña y fecha de alta.
 * 
 * 
...
public class Distribuidor {
	 ...
	 * @param user      Representa el nick del distribuidor para darse de alta en el
	 *                  sistema.
	 * @param password  Representa la contraseña del distribuidor para entrar en el
	 *                  sistema
	...
	/**
	 * Establece el numero de telefono del distribuidor al valor entero pasado por
	 * parametro
	 * 
	...
	/**
	 * Estable el codigo postal del distribuidor al valor entero pasado por
	 * parametro.
	 * 
	...
	/**
	 * Devuelve el valor de tipo String que representa el domicilio de envio del
	 * distribuidor.
	 * 
	...
	/**
	 * Establece la fecha de alta del sitema del distribuidor al valor pasado por
	 * parametro
	 * 
