...
public class Gui_Pedido extends javax.swing.JFrame {
	...
	/**
	 * Clase que representa y crea la interfaz grafica de visualizacion de los
	 * pedidos del sistema
	 *
	...
	/**
	 * Constructor por defecto que llama al metodo privado que inicializa los
	...
	/**
	 * Funcion privada que crea e inicia los componentes de la interfaz grafica
	 */
	private void initComponents() {
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								layout.createSequentialGroup().addGap(20, 20, 20).addComponent(jPanel1,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(layout.createSequentialGroup().addGap(40, 40, 40)
								.addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 410,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(33, 33, 33)
								.addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 140,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(17, 17, 17).addComponent(idPedido))
						.addGroup(layout.createSequentialGroup().addGap(580, 580, 580).addComponent(verPedido,
								javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(layout.createSequentialGroup().addGap(30, 30, 30).addComponent(jPanel2,
								javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jLabel1).addComponent(idPedido))))
						.addGap(6, 6, 6)
						.addComponent(verPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
								javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		verPedido.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				if (entero != -1)
					...
					JOptionPane.showMessageDialog(null, "Error; no ha seleccionado ningun pedido para visualizar."
							+ " Seleccione uno de ellos para poder ver su contenido", "Ventas - Pedidos", 2);
				}
	...
	/**
	 * Funcion privada que crea la tabla de los pedidos que hay en el sistema
	 * mediante la clase que se encarga de la llamada y consumo del servicio web
	 * pertinente
	 */
	private void contruirTabla() {
		...
		if (!list.isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "NO HAY NINGUN PEDIDO EN EL SISTEMA", "Ventas - Pedidos", 2);

		}
	}

	/**
	 * Funcion que se ejecuta cuando se ha seleccionado un pedido de la tabla y se
	 * pulsa en el boton de ver Pedido. Esta funcion privada muestra los articulos y
	 * sus caracteristicas del pedido en cuestion. Llama al a clase correspondiente
	 * que se encarga de consumir el servicio web que satisface esta necesidad.
	 */
	private void rellenarTablaArticulos() {
		...
		while (it.hasNext()) {
			...
			if (p.isRealizado() && p.isEmbalado()) {
				...
				Object[] row = { p.getArticulo().getId_articulo(), p.getArticulo().getNombre(),
						p.getArticulo().getPrecio(), p.getCant(), "SI", "SI" };
			...
			if (p.isRealizado() && !p.isEmbalado()) {
				...
				Object[] row = { p.getArticulo().getId_articulo(), p.getArticulo().getNombre(),
						p.getArticulo().getPrecio(), p.getCant(), "SI", "NO" };
			...
			if (!p.isRealizado() && p.isEmbalado()) {
				...
				Object[] row = { p.getArticulo().getId_articulo(), p.getArticulo().getNombre(),
						p.getArticulo().getPrecio(), p.getCant(), "NO", "SI" };
				...
				Object[] row = { p.getArticulo().getId_articulo(), p.getArticulo().getNombre(),
						p.getArticulo().getPrecio(), p.getCant(), "NO", "NO" };
